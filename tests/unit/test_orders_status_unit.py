...
def test_update_main_status_happy_path(client):
...
def test_update_main_status_order_not_found(client, monkeypatch):
...
def test_update_main_status_unauthorized_restaurant(client, monkeypatch):
