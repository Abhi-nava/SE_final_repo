 ...
 useEffect(() => {
  ...
  const roles = [
    ...
    },
    {
      ...
      description: "Join our delivery team and start earning today!",
      icon: Bike,
  ...
  return (
    <main className="min-h-screen bg-background">
      <nav className="border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-foreground">FoodFlow</span>
          </div>
          <Button
            onClick={() => {
              ...
              return (
                <Card key={role.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <p className="dark mb-6">{role.description}</p>
            ...
            {features.map((feature, idx) => {
              ...
              return (
                <div key={idx} className="text-center">
                  ...
                  <p className="dark">{feature.description}</p>
                </div>
              )
            })}
          </div>
      ...
      <footer className="border-t border-border bg-bg-alt">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center dark">
