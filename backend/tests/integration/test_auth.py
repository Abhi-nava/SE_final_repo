...
async def test_verify_2fa_invalid_otp(client_and_db):
    ...
    temp_token = TwoFactorAuthToken.create_temp_token(str(user_id), "wrong2fa@example.com")
...
async def test_forgot_password_reset(client_and_db):
    ...
    reset_session_token = PasswordResetToken.create_reset_session_token("complete-reset@example.com")
